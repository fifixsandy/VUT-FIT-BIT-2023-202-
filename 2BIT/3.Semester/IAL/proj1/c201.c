...
void List_InsertFirst( List *list, int data ) {
	...
	newElement->nextElement = list->firstElement; // insert it before the initial first
...
void List_DeleteFirst( List *list ) {
	...
	ListElementPtr tmp = list->firstElement->nextElement; // store it so the reference will not be lost
...
void List_DeleteAfter( List *list ) {
	...
	ListElementPtr tmp = list->activeElement->nextElement->nextElement; // store it so the reference will not be lost
